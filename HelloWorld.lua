...
local Toggle = Tabs.LPlayer:AddToggle("Invisible", {Title = "Invisible (Not Working)", Default = false})
...
-- Function to check if a part has TouchInterest and CoinVisual, and ignore parts with MainCoin
local function hasTouchInterestAndCoinVisual(part)
...
-- Function to find the nearest untapped Coin_Server part with TouchInterest and CoinVisual, ignoring MainCoin
local function findNearestUntappedCoin()
    local nearestCoin = nil
    local nearestDistance = math.huge
    ...
    if player and player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
        ...
        if normalContainer then
            ...
            if coinContainer then
                ...
                -- Find the nearest "Coin_Server" part with TouchInterest and valid CoinVisual (ignoring MainCoin)
                for _, coinServer in ipairs(coins) do
                    if hasTouchInterestAndCoinVisual(coinServer) and not touchedCoins[coinServer] then

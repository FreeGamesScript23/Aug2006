		...
		function Window:Minimize()
			...
			if not MinimizeNotif then
				...
				if not Mobile then Library:Notify({
					Title = getgenv().AshTitle,
					Content = "Press " .. Key .. " to toggle the interface. Loading the UI Please Wait",
					Duration = 6
					})
				else 
					Library:Notify({
						Title = getgenv().AshTitle,
						Content = "Tap to the button to toggle the interface. Loading the UI Please Wait",
						Duration = 6
					})
				end
			end
...
function Dropdown:Close()
    ...
    -- optional: destroy children to free memory

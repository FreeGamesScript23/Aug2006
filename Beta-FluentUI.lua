...
local aa = {
    function()
        ...
        local t, u, v, InteractNotifComponent = e(s.Notification), p.New, protectgui or (syn and syn.protect_gui) or function(), e(s.InteractableNotif)
    end    
        ...
        function x.ToggleTransparency(C, D)
            if x.Window then
                x.Window.AcrylicPaint.Frame.Background.BackgroundTransparency = D and 0.4 or 0
            end
        end
    ...
    [49] = function()
        ...
        return {
            Name = "Aqua",
            Accent = Color3.fromRGB(90, 200, 200),
            AcrylicMain = Color3.fromRGB(30, 30, 30),
            AcrylicBorder = Color3.fromRGB(60, 130, 130),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(90, 190, 190), Color3.fromRGB(60, 120, 120)),
            AcrylicNoise = 0.92,
            TitleBarLine = Color3.fromRGB(80, 160, 160),
            Tab = Color3.fromRGB(170, 210, 210),
            Element = Color3.fromRGB(140, 190, 190),
            ElementBorder = Color3.fromRGB(50, 90, 90),
            InElementBorder = Color3.fromRGB(100, 140, 140),
            ElementTransparency = 0.85,
            ToggleSlider = Color3.fromRGB(140, 190, 190),
            ToggleToggled = Color3.fromRGB(0, 0, 0),
            SliderRail = Color3.fromRGB(140, 190, 190),
            DropdownFrame = Color3.fromRGB(190, 230, 230),
            DropdownHolder = Color3.fromRGB(50, 100, 100),
            DropdownBorder = Color3.fromRGB(50, 80, 80),
            DropdownOption = Color3.fromRGB(140, 190, 190),
            Keybind = Color3.fromRGB(140, 190, 190),
            Input = Color3.fromRGB(140, 190, 190),
            InputFocused = Color3.fromRGB(30, 15, 40),
            InputIndicator = Color3.fromRGB(150, 200, 200),
            Dialog = Color3.fromRGB(50, 100, 100),
            DialogHolder = Color3.fromRGB(40, 80, 80),
            DialogHolderLine = Color3.fromRGB(35, 70, 70),
            DialogButton = Color3.fromRGB(50, 100, 100),
            DialogButtonBorder = Color3.fromRGB(90, 130, 130),
            DialogBorder = Color3.fromRGB(60, 120, 120),
            DialogInput = Color3.fromRGB(55, 110, 110),
            DialogInputLine = Color3.fromRGB(150, 200, 200),
    ...
    [53] = function()
        ...
        return {
            ...
            AcrylicBorder = Color3.fromRGB(160, 110, 130),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(210, 70, 150), Color3.fromRGB(190, 55, 90)),
            AcrylicNoise = 0.92,
            TitleBarLine = Color3.fromRGB(160, 100, 120),
            Tab = Color3.fromRGB(200, 160, 180),
            Element = Color3.fromRGB(220, 140, 180),
            ElementBorder = Color3.fromRGB(130, 90, 105),
            InElementBorder = Color3.fromRGB(140, 100, 110),
            ElementTransparency = 0.86,
            ToggleSlider = Color3.fromRGB(220, 140, 180),
            ToggleToggled = Color3.fromRGB(0, 0, 0),
            SliderRail = Color3.fromRGB(220, 140, 180),
            DropdownFrame = Color3.fromRGB(220, 170, 190),
            DropdownHolder = Color3.fromRGB(140, 60, 90),
            DropdownBorder = Color3.fromRGB(110, 50, 70),
            DropdownOption = Color3.fromRGB(220, 140, 180),
            Keybind = Color3.fromRGB(220, 140, 180),
            Input = Color3.fromRGB(220, 140, 180),
            InputFocused = Color3.fromRGB(30, 15, 35),
            InputIndicator = Color3.fromRGB(180, 160, 200),
            Dialog = Color3.fromRGB(140, 60, 90),
            DialogHolder = Color3.fromRGB(110, 50, 75),
            DialogHolderLine = Color3.fromRGB(100, 45, 65),
            DialogButton = Color3.fromRGB(140, 60, 90),
            DialogButtonBorder = Color3.fromRGB(175, 110, 135),
            DialogBorder = Color3.fromRGB(120, 80, 100),
            DialogInput = Color3.fromRGB(150, 65, 95),
            DialogInputLine = Color3.fromRGB(210, 170, 190),
            Text = Color3.fromRGB(240, 240, 240),
            SubText = Color3.fromRGB(180, 180, 180),

...
if not getgenv or not genv.AshExecuted then
    genv.AshExecuted = true
else
    ...
    Fluent:Notify({
        Title = string.char(65, 115, 104, 98, 111, 114, 110, 110, 72, 117, 98, 32, 78, 111, 116, 105, 102, 121),
        Content = "The script is already executed. If you're having any problems, join my discord for support.",
        SubContent = "Wanna load the script again?",
        Duration = 10,
        Buttons = {
            Yes = {
                Text = "Yes",
                Callback = function()
                    if debounce then
                        Fluent:Notify({
                            Title = string.char(65, 115, 104, 98, 111, 114, 110, 110, 72, 117, 98, 32, 78, 111, 116, 105, 102, 121),
                            Content = "Please calm sir Im already loading the script 😑",
                            SubContent = "If the script isn't really loading means Ashbornn messed up something lol.",
                            Duration = 5
                        })
                        return
                    end
                    ...
                    loadstring(game:HttpGet("https://raw.githubusercontent.com/FreeGamesScript23/Aug2006/refs/heads/main/FluentUI-Modified.lua"))()
                    ...
                    local deviceType = isTouchscreen and "Mobile" or "PC"
                    ...
                    if games[placeId] then
                        loadstring(game:HttpGet('https://raw.githubusercontent.com/FreeGamesScript23/Aug2006/main/' .. games[placeId] .. '.lua'))()
                    else
                    end
                end,
            },
...
genv.Ash_Device = Touchscreen and "Mobile" or "PC"
sendnotification(Ash_Device .. " detected.", false)

genv.Ash_Hook = (type(hookmetamethod) == "function" and type(getnamecallmethod) == "function") and "[✅]Supported" or "[⛔]Unsupported"
sendnotification("Hook method is " .. Ash_Hook .. ".", false)

genv.Ash_Drawing = (type(Drawing.new) == "function") and "[✅]Supported" or "[⛔]Unsupported"
